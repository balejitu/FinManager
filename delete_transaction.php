...
session_start();
if ( isset($_POST['delete']) && isset($_POST['trans_id']) && isset($_POST['amount']))
 {
    ...
    $stmt->execute(array(':zip' => $_POST['trans_id']));
...
$stmt = $pdo->prepare("SELECT description, acc_id, amount FROM transaction_info where trans_id = :xyz");
